...
CREATE TABLE `answeroptions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `questionaire_answers_id` bigint(20) UNSIGNED NOT NULL,
  `sub_options` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `bank_details` (
  ...
  `routing_number` varchar(9) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_number` varchar(17) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `social_security_number` varchar(9) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `bank_details` (`id`, `user_id`, `account_type`, `name`, `routing_number`, `account_number`, `social_security_number`, `date_of_birth`, `status`, `created_at`, `updated_at`) VALUES
(5, 147, 'checking', 'bank al habib', '123456789', '11223344556677889', '213-21-31', '2022-07-11', 1, '2022-07-27 04:52:04', '2022-08-01 07:48:50'),
(6, 147, 'checking', 'paypal', '909090987', '50250081000591019', '090908769', '1994-12-03', 0, '2022-08-01 09:39:40', '2022-08-01 07:48:50');
...
--
-- Table structure for table `contribution_amounts`
--
...
--
-- Dumping data for table `contribution_amounts`
--

INSERT INTO `contribution_amounts` (`id`, `user_id`, `amount`, `bill`, `plan_id`, `comment`, `status`, `created_at`, `updated_at`) VALUES
(5, 147, 60000.00, 60000.00, 87, '1stcontribution', 1, '2022-07-27 04:52:04', '2022-07-27 04:52:04'),
(7, 147, 700.00, 0.00, 88, '2ndcontribution', 1, '2022-07-28 10:48:16', '2022-07-28 10:48:16'),
(8, 147, 8000.00, 0.00, 89, '3rdcontribution', 1, '2022-07-28 12:54:09', '2022-07-28 12:54:09');
...
(6, 147, 'Tenats in common', '2XFWvo0Ihm', 'qdadasdsad', 'karachi', 'California', '11223', '2XFWvo0Ihm', 'aasdasd', 'karachi', 'California', '11223', '2022-07-27 07:40:06', '2022-07-27 07:40:06');
...
(27, '2022_07_21_153324_create_contribution_amounts_table', 16),
(28, '2022_07_22_100639_create_bank_details_table', 17);
...
CREATE TABLE `questionaires` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `overline` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `questionaires` (`id`, `overline`, `question`, `url_slug`, `status`, `created_at`, `updated_at`) VALUES
...
(12, 'Let’s finish getting your account set up.', 'What type of account would you like to open?', 'select-account-form', 1, NULL, NULL),
(14, 'Your account details look good.', ' Please choose a source of funds. ', 'funds', 1, NULL, NULL),
(15, NULL, 'How would you like to fund your IRA?', 'fund-ira', 1, NULL, NULL),
(16, NULL, 'What type of IRA would you like to open?', 'ira-type', 1, NULL, NULL),
(17, NULL, 'Select your investment plan', 'plan', 1, NULL, NULL),
(18, NULL, 'What type of IRA do you want to transfer?', 'ira-transfer', 1, NULL, NULL),
(19, NULL, 'What type of account will your funds be coming from?', 'coming-fund-account', 1, NULL, NULL),
(20, NULL, 'Dividend Reinvestments?', 'dividend-reinvestment', 1, NULL, NULL);
...
CREATE TABLE `questionaire_answers` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(80, 14, 'Link a bank account', 'Use your online banking credentials to securely connect a bank account.', NULL, NULL),
(81, 14, 'Enter a bank account manually', 'Manually enter your bank’s routing and account numbers.', NULL, NULL),
(82, 15, 'New contribution', 'Make a contribution to your Fundrise IRA, subject to IRS annual contribution limit', NULL, NULL),
(83, 15, 'Transfer an IRA', 'Transfer an existing IRA to your Fundrise IRA', NULL, NULL),
(84, 15, 'Rollover an employer-sponsored retirement plan', 'Rollover an existing 401(k), or another employer-sponsored plan to your Fundrise IRA', NULL, NULL),
(85, 16, 'Traditional IRA', 'A retirement account that benefits from tax-deferred growth. Contributions are tax-deductible in the year they are made, but you\'ll pay taxes on any withdrawal in retirement', NULL, NULL),
(86, 16, 'Roth IRA', 'A retirement account that benefits from tax-free growth. Contribute after-tax dollars, and you will not pay taxes on withdrawals in retirement', NULL, NULL),
(87, 17, 'Supplemental income', 'Create an attractive, consistent income stream', NULL, NULL),
(88, 17, 'Balanced investing', 'Build wealth confidently with high diversification', NULL, NULL),
(89, 17, 'Long-term growth', 'Persue superior overall returns over the long term', NULL, NULL),
(90, 18, 'Roth IRA', NULL, NULL, NULL),
(91, 18, 'SEP IRA', NULL, NULL, NULL),
(92, 18, 'SIMPLE IRA', NULL, NULL, NULL),
(93, 18, 'Traditional IRA', NULL, NULL, NULL),
(94, 19, '401(k)', NULL, NULL, NULL),
(95, 19, '403(b)', NULL, NULL, NULL),
(96, 19, '457(b)', NULL, NULL, NULL),
(97, 20, 'I would like my dividends reinvested according to the investment plan I have selected.', NULL, NULL, NULL),
(98, 20, 'I would like my dividends distributed to my bank account.', NULL, NULL, NULL);
...
INSERT INTO `transactions` (`id`, `user_id`, `amount`, `charge`, `post_balance`, `trx_type`, `trx`, `wallet_type`, `details`, `created_at`, `updated_at`) VALUES
(1, 1, '10.00000000', '0.00000000', '10.00000000', '+', 'A93Q7334BDGO', 'deposit_wallet', 'You have got Sign Up Bonus', '2022-06-29 06:03:56', '2022-06-29 06:03:56');
...
CREATE TABLE `users` (
  ...
  `notification_setting` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `email`, `mobile`, `ref_by`, `password`, `image`, `address`, `city`, `state`, `zip_code`, `country_of_citizenship`, `country_of_residence`, `age`, `deposit_wallet`, `interest_wallet`, `status`, `notification_setting`, `ev`, `sv`, `ver_code`, `ver_code_send_at`, `ts`, `tv`, `tsc`, `provider`, `provider_id`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Shahrukh Akhter', 'Siddiqui', 'Shahrukh509', 'srkshah1998@gmail.com', '923442464509', NULL, '$2y$10$GLsVmCFLDVfhtCjWmgTqgefw1bRbDk8fbU.Z.1qY6BSg.YdEMrCDa', NULL, '{\"address\":\"\",\"state\":\"\",\"zip\":\"\",\"country\":\"Pakistan\",\"city\":\"\"}', NULL, NULL, NULL, NULL, NULL, NULL, '10.00000000', '0.00000000', 1, NULL, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, '2022-06-29 06:03:55', '2022-06-29 06:03:56'),
(147, 'ahsan aabid', 'Siddiqui', 'ahsan1', 'admin1@admin.com', '121231', NULL, '$2y$10$ianYo8erHzYsJ7x2WEkBie8JxfVDa5qu.pIEfBrR98RuwFA8mrWru', NULL, '\"karachi11 andheri gali\"', 'islamabad', 'boot', '11223', 'Pakistan', 'America', 22, '0.00000000', '0.00000000', 1, '{\"InsightsAndResources\":\"1\",\"ProductAndFeatureAnnouncements\":\"1\",\"PortfolioPerformance\":0,\"ProjectUpdates\":0,\"Newsletter\":0}', 0, 0, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, '2022-07-27 03:58:20', '2022-08-01 07:48:27'),
(148, NULL, NULL, NULL, 'abc@gmail.com', NULL, NULL, '$2y$10$sE3B.inoPJEQfNIREIth0ugb6cUh9ivU2ncH.89UFMssYJlFJZFVq', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, '0.00000000', '0.00000000', 1, NULL, 0, 0, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, '2022-07-27 10:31:24', '2022-07-27 10:31:36');
...
(350, 147, 11, 76, NULL, '2022-07-27 03:58:40', '2022-07-27 03:58:40'),
(351, 147, 2, 45, NULL, '2022-07-27 03:58:46', '2022-07-27 03:58:46'),
(352, 147, 3, 52, NULL, '2022-07-27 03:58:48', '2022-07-27 03:58:48'),
(353, 147, 4, 72, NULL, '2022-07-27 03:58:50', '2022-07-27 03:58:50'),
(354, 147, 5, 54, NULL, '2022-07-27 03:58:53', '2022-07-27 03:58:53'),
(355, 147, 6, 60, NULL, '2022-07-27 03:58:56', '2022-07-27 03:58:56'),
(356, 147, 7, 65, NULL, '2022-07-27 03:58:59', '2022-07-27 03:58:59'),
(357, 147, 12, 78, NULL, '2022-07-27 03:59:50', '2022-07-27 03:59:50'),
(358, 147, 14, 81, NULL, '2022-07-27 04:52:04', '2022-07-27 04:52:04'),
(359, 148, 11, 76, NULL, '2022-07-27 10:31:32', '2022-07-27 10:31:32'),
(360, 148, 2, 45, NULL, '2022-07-27 10:31:38', '2022-07-27 10:31:38'),
(361, 148, 3, 50, NULL, '2022-07-27 10:31:42', '2022-07-27 10:31:42'),
(362, 148, 4, 72, NULL, '2022-07-27 10:31:44', '2022-07-27 10:39:48'),
(363, 148, 5, 58, NULL, '2022-07-27 10:31:47', '2022-07-27 10:44:06'),
(364, 148, 6, 61, NULL, '2022-07-27 10:31:55', '2022-07-27 10:39:52'),
(365, 148, 7, 65, NULL, '2022-07-27 10:32:03', '2022-07-27 10:39:54'),
(366, 147, 17, 87, NULL, '2022-07-28 04:52:04', '2022-07-28 04:52:04'),
(368, 147, 20, 98, NULL, NULL, '2022-08-01 07:48:45');
...
(4, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 03:36:27', '2022-07-28 03:36:27'),
(5, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 08:56:33', '2022-07-28 08:56:33'),
(6, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:03:35', '2022-07-28 11:03:35'),
(7, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:04:02', '2022-07-28 11:04:02'),
(8, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:04:31', '2022-07-28 11:04:31'),
(9, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:07:57', '2022-07-28 11:07:57'),
(10, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:08:32', '2022-07-28 11:08:32'),
(11, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:09:33', '2022-07-28 11:09:33'),
(12, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:10:42', '2022-07-28 11:10:42'),
(13, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:14:28', '2022-07-28 11:14:28'),
(14, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:17:59', '2022-07-28 11:17:59'),
(15, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:35:26', '2022-07-28 11:35:26'),
(16, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-28 11:36:05', '2022-07-28 11:36:05'),
(17, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-07-29 05:13:52', '2022-07-29 05:13:52'),
(18, 147, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '', '2022-08-01 03:56:27', '2022-08-01 03:56:27');
...
ALTER TABLE `answeroptions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `answeroptions_questionaire_answers_id_foreign` (`questionaire_answers_id`);
...
--
-- Indexes for table `contribution_amounts`
--
ALTER TABLE `contribution_amounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contribution_amounts_user_id_foreign` (`user_id`);
...
--
-- Indexes for table `questionaire_answers`
--
ALTER TABLE `questionaire_answers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `questionaire_answers_questionaire_id_foreign` (`questionaire_id`);
...
--
-- AUTO_INCREMENT for table `contribution_amounts`
--
ALTER TABLE `contribution_amounts`
...
--
ALTER TABLE `questionaire_answers`
  ADD CONSTRAINT `questionaire_answers_questionaire_id_foreign` FOREIGN KEY (`questionaire_id`) REFERENCES `questionaires` (`id`) ON DELETE CASCADE;
