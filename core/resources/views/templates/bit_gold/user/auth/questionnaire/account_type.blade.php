   ...
   <section class=" container-fluid d-flex justify-content-center fom_sec ">
    ...
    @endphp
        ...
        <div class="col-12 col-lg-8 ">
                ...
                <form id="form-account-type" name="leadCapture" class="lead-capture position-relative mt-25" action="{{ route('user.step.account.type.store') }}" data-slug="age" question-id="{{ $question->id }}" >
