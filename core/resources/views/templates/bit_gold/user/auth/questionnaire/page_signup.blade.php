                               ...
                               <div class="form-card">
                                  ...
                                  @php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="initial_contribution" placeholder="Enter an amount" name="initial_contribution_amount" value="{{ $contribution->amount }}">
                                   ...
                                   {{ $question->question }}</h1>
                                    ...
                                    <small>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="social_security" placeholder="xxx-xx-xxxx" name="social_security_number" value="{{ $bank_details->social_security_number }}">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date_of_birth" placeholder="mm/dd/yy" name="date_of_birth" value="{{ $bank_details->date_of_birth }}">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inputAddress2" placeholder="Name" name="bank_name" value="{{ $bank_details->name }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="inputAddress2" placeholder="routing number" name="routing_number" value="{{ $bank_details->routing_number }}">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="account_number" placeholder="account number" name="bank_account_number" value="{{ $bank_details->account_number }}">
