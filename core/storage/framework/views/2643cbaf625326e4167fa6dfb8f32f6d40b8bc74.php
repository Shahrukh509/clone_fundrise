    ...
    <div class="row mb-none-30">
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="<?php echo e(getImage('assets/images/user/profile/'. $user->image)); ?>" alt="profile-image"
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <?php echo app('translator')->get('Deposit Wallet'); ?>
                                <span class="font-weight-bold"><?php echo e($general->cur_sym); ?><?php echo e(getAmount($user->deposit_wallet)); ?></span>
                            </li>

                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <?php echo app('translator')->get('Interest Wallet'); ?>
                                <span class="font-weight-bold"><?php echo e($general->cur_sym); ?><?php echo e(getAmount($user->interest_wallet)); ?></span>
                            </li>
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('admin.users.email.log',$user->id)); ?>" class="btn btn--dark btn--shadow btn-block btn-lg">
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--1 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount"><?php echo e(number_format($totalDeposit,2)); ?></span>
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--15 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount"><?php echo e(number_format($totalWithdraw,2)); ?></span>
                                <span class="currency-sign"><?php echo e($general->cur_sym); ?></span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--11 b-radius--10 box-shadow has--link">
                        <a href="<?php echo e(route('admin.users.invests',$user->id)); ?>" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-money-bill"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount"><?php echo e($totalInvest); ?></span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--18 b-radius--10 box-shadow has--link">
                        <a href="<?php echo e(route('admin.users.referrals',$user->id)); ?>" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-users"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount"><?php echo e($totalReferral); ?></span>
                            </div>
                            <div class="desciption">
                                <span><?php echo app('translator')->get('Total Referral'); ?></span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--12 b-radius--10 box-shadow has--link">
                        <a href="<?php echo e(route('admin.users.commissions.deposit',$user->id)); ?>" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-money"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount"><?php echo e(number_format($totalCommission,2)); ?></span>
                                <span class="currency-sign"><?php echo e($general->cur_sym); ?></span>
                            </div>
                            <div class="desciption">
                                <span><?php echo app('translator')->get('Referral Commission'); ?></span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
            ...
            <div class="card mt-50">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2"><?php echo e($user->fullname); ?> <?php echo app('translator')->get('Information'); ?></h5>
                ...
                <form action="<?php echo e(route('admin.users.addSubBalance', $user->id)); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Select Wallet'); ?><span class="text-danger">*</span></label>
                                <select name="wallet" class="form-control" required>
                                    <option value="deposit_wallet"><?php echo app('translator')->get('Deposit Wallet'); ?></option>
                                    <option value="interest_wallet"><?php echo app('translator')->get('Interest Wallet'); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group has_append">
                                    ...
                                    <div class="input-group-append">
                                        <div class="input-group-text"><?php echo e(trans($general->cur_sym)); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\towork\core\resources\views/admin/users/detail.blade.php ENDPATH**/ ?>