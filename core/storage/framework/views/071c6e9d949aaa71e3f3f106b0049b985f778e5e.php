                            ...
                            <table class="default-data-table table ">
                                ...
                                <tr>
                                    ...
                                    <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($k !='modal'): ?>
                                            <?php if($type=='text' || $type=='icon' || $type == 'date'): ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <?php echo app('translator')->get('Add New'); ?> <?php echo e(inputTitle($key)); ?> Item</h5>
                            ...
                            <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($k != 'modal'): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e(inputTitle($k)); ?></label>
                                            <input type="<?php echo e($type); ?>" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" required/>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\towork\core\resources\views/admin/frontend/index.blade.php ENDPATH**/ ?>