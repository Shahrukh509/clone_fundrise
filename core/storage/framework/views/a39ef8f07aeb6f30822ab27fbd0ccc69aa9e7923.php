        ...
        <div class="form-area bg_img" data-background="<?php echo e(asset('assets/admin/images/1.jpg')); ?>">
            <div class="form-wrapper">
                ...
                <form action="<?php echo e(route('admin.login')); ?>" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        <button type="submit" class="submit-btn mt-25 b-radius--capsule"><?php echo app('translator')->get('Login'); ?> <i
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clone_fundrise\core\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>