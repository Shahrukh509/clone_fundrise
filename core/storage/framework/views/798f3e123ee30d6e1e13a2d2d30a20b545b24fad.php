...
<head>
    ...
    <!-- data table css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/vendor/datatables.min.css')); ?>">
    <!-- jvectormap css -->
...
<!-- data-table js -->
<script src="<?php echo e(asset('assets/admin/js/vendor/datatables.min.js')); ?>"></script>
<!-- main js -->
...
<?php /**PATH C:\xampp\htdocs\clone_fundrise\core\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>