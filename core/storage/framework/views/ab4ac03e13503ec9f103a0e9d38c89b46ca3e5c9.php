        ...
        <form id="form-age"name="leadCapture" class="lead-capture position-relative mt-25" action="<?php echo e(route('user.step.age.store')); ?>">
            <div class="lead-capture__fieldset">
                ...
                <div class=" d-flex justify-content-end pt-4">
                    <button id="load-button" type="submit" class="button button-fundrise-orange " data-test="lead-capture-submit"> Continue </button>
                    <span class="age-error"></span>
                </div>
            </div>
        </form>
    </div>
</section><?php /**PATH C:\xampp\htdocs\towork\core\resources\views/templates/bit_gold/user/auth/questionnaire/ajax_age.blade.php ENDPATH**/ ?>