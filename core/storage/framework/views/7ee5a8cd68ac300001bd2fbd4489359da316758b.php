   ...
   <section class=" container-fluid d-flex justify-content-center fom_sec ">
    ...
    ?>
        ...
        <div class="col-12 col-lg-8 ">
                ...
                <form id="form-account-type" name="leadCapture" class="lead-capture position-relative mt-25" action="<?php echo e(route('user.step.account.type.store')); ?>" data-slug="age" question-id="<?php echo e($question->id); ?>" >
                            ...
                            <ul class="radio-checkbox-list pl-0">
                                ...
                                <li class="radio-checkbox-item-large"><label>
                                    <input type="radio" id="account_type" name="account_type"
                                            data-test="TAXABLE" value="<?php echo e($data->id); ?>"<?php echo e($answer->questionaire_answer_id == $data->id?'checked':''); ?>>
...
<?php echo $__env->make($activeTemplate.'user.auth.questionnaire.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\towork\core\resources\views/templates/bit_gold/user/auth/questionnaire/account_type.blade.php ENDPATH**/ ?>