                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="<?php echo app('translator')->get('Country'); ?>">
                                    <span class="font-weight-bold" data-toggle="tooltip"><?php echo e(@$user->address->country); ?></span>
                                </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\towork\core\resources\views/admin/users/list.blade.php ENDPATH**/ ?>